                            ...
                            &[vk::GraphicsPipelineCreateInfo::builder()
                                ...
                                .vertex_input_state(
                                    &vk::PipelineVertexInputStateCreateInfo::builder()
                                        ...
                                        }]), //? Shouldn't this use the padded size? or am I misunderstanding that? If I am, fix the functions that make the vertex/index buffer, right now it doesn't matter though, as they seem to always be the same
                                )
